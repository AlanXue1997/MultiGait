...
% for i=2:total_num
%     bg = bg + uint16(imread(sprintf('.\\CASIA_data\\fyc\\00_1\\fyc-00_1-0%02d.png',i)));
% end
% vid = uint16(imread(sprintf('.\\CASIA_data\\fyc\\00_1\\fyc-00_1-0%02d.png',seg_rank)));
% 
% bg = bg ./ total_num;
% 
...
for i = 1:total_num
    frame = imread(sprintf('.\\CASIA_data\\fyc\\00_1\\fyc-00_1-0%02d.png',i)); % read the next video frame
    step(foregroundDetector, frame);
end

frame = imread(sprintf('.\\CASIA_data\\fyc\\00_1\\fyc-00_1-0%02d.png',seg_rank)); % read the next video frame
